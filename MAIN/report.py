...
Supports JSON, CSV, and self-contained HTML reports with embedded plots.
"""
...
<head>
    ...
    <title>Antigravity SIGINT Intel Report</title>
...
<body>
    <div class="header-section text-center">
        <h1>Antigravity SIGINT Intel Report</h1>
    ...
    <div class="container">
        ...
        <footer class="text-center mt-4 text-muted">
            <p>&copy; 2026 Antigravity SIGINT Systems Engineering</p>
        </footer>
    </div>
</body>
</html>
