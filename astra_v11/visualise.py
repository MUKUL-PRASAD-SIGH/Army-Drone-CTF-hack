...
from astra_v11.config import PLOT_STYLE, PLOTS_DIR
from astra_v11.models import Packet, StreamStats
...
def plot_sequence_counters(packets: List[Packet]):
    ...
    sns.lineplot(data=df, x="index", y="sequence", hue="stream_id", marker='o', markersize=2)
